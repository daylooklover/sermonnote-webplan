...
const translations = {
    ...
    en: {
        ...
        // ⭐️ FIX: 누락된 설교 유형 설명 키 추가
        aiAssistantDesc: 'The AI assistant helps draft sermons based on your topic or scripture reference.',
        expositoryDesc: 'Deeply analyzes scripture texts and structures them to create a powerful expository sermon.',
        realLifeDesc: 'Creates sermons focused on real-life application, connecting to modern social issues and life struggles.',
        quickMemoDesc: 'Quickly and easily expands brief inspirations or meditation notes into a rich sermon.',
        rebirthDesc: 'Upload existing sermon materials, and the AI will reorganize and enhance them into a modern style.',
        upgradeDesc: 'Experience all AI features and unlimited sermon generation through a Premium subscription.',
    },
    ...
    zh: {
        ...
        limitedSupport: '优先技术支持 (有限)', unlimitedSermonGen: '无限次讲道생성',
        ...
        // ⭐️ FIX: 누락된 설교 유형 설명 키 추가
        aiAssistantDesc: 'AI 助手会根据您的话题或经文参考来起草讲道稿。',
        expositoryDesc: '深入分析经文并进行结构化，以完成强有力的释经讲道。',
        realLifeDesc: '创建以实际生活应用为中心的讲道，连接现代社会问题和生活困境。',
        quickMemoDesc: '将涌现的简短灵感或默想笔记快速轻松地扩展为丰富的讲道。',
        rebirthDesc: '上传现有的讲道材料，AI 将其重组并增强为现代风格。',
        upgradeDesc: '通过高级版订阅，体验所有 AI 功能和无限次的讲道生成。',
    },
    ...
    ru: {
        ...
        // ⭐️ FIX: 누락된 설교 유형 설명 키 추가
        aiAssistantDesc: 'AI помощник помогает составить черновик проповеди на основе вашей темы или ссылки на Писание.',
        expositoryDesc: 'Глубоко анализирует тексты Писания и структурирует их для создания мощной экспозиционной проповеди.',
        realLifeDesc: 'Создает проповеди, ориентированные на практическое применение в жизни, связанные с современными социальными проблемами и жизненными трудностями.',
        quickMemoDesc: 'Быстро и легко преобразует краткие вдохновения или заметки для размышлений в богатую проповедь.',
        rebirthDesc: 'Загрузите существующие материалы проповедей, и AI реорганизует и дополнит их в современном стиле.',
        upgradeDesc: 'Получите доступ ко всем функциям AI и неограниченной генерации проповедей с помощью Премиум-подписки.',
    },
    ...
    vi: {
        ...
        landing_title_5: 'Duy trì cảm hứng, thúc진 sự suy ngẫm sâu sắc hơn', landing_summary_5: 'Không bỏ lỡ những cảm hứng bất chợ트와 làm sâu sắc hơn một cách có hệ thống giai đoạn suy ngẫm bài giảng.',
