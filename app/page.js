...
import RebirthSermonFeature from '@/components/RebirthSermonFeature';
...
import {
    ...
    RebirthIcon, PremiumIcon, QuickMemoIcon, ChatIcon // 🚨 ChatIcon을 추가합니다.
...
const translations = {
    ...
    ko: {
        ...
        // **********************************************
        // 🔑 인증 및 로그인 관련 키 (LoginModal.js 및 HomeContent.js에서 사용)
        // **********************************************
        auth_error_title: '인증 시스템 오류',
        auth_error_desc: '사용자 인증 정보를 불러오지 못했습니다. 잠시 후 다시 시도하거나, 관리자에게 문의하세요。',
        auth_invalid_email: '유효하지 않은 이메일 주소 형식입니다.',
        auth_user_disabled: '계정이 비활성화되었습니다.',
        ...
        auth_generic_error: '예상치 못한 인증 오류가 발생했습니다: {0}', // 👈 추가된 키
        auth_password_mismatch: '비밀번호와 확인 비밀번호가 일치하지 않습니다.',
        auth_register_success: '회원가입 성공! 자동으로 로그인됩니다.',
        auth_login_success: '로그인 성공!',
        auth_reset_sent: '비밀번호 재설정 링크가 이메일로 전송되었습니다. 이메일을 확인해 주세요.',
        ...
        auth_send_reset: "재설정 이메일 보내기",
        auth_reset_prompt: "비밀번호가 기억나셨나요?",
        auth_back_to_login: "로그인으로 돌아가기",
        auth_registering: '회원가입 중...',
        auth_processing: '처리 중...',
        auth_continue_anon: '로그인 없이 앱 계속 사용',
        ...
        copilotAssistant: '말씀노트 Q&A 코파일럿',
        copilotDesc: '말씀노트 사용법, 기능, 오류 해결에 대한 질문에 즉시 답변해 드립니다.',
        copilotInputPlaceholder: '말씀노트 사용법에 대해 질문하세요...',
        copilotFAB: '코파일럿 열기', // 🚨 코파일럿 FAB 버튼 툴팁 추가
        // 🚨 Paddle 에러 메시지 키 추가 (구독 업그레이드 오류 대응)
        paddle_sdk_error: "결제 서비스 초기화 오류. 잠시 후 다시 시도하거나 관리자에게 문의하십시오。",
        paddle_checkout_success: "구독에 성공했습니다! 잠시 후 계정이 업데이트됩니다。",
        paddle_checkout_closed: "결제가 취소되었거나 실패했습니다。", // <--- ⚠️ 쉼표 추가!
        // 🎤 Quick Memo 관련 키 추가
        memo_start_guide: '짧은 영감을 녹음하려면 마이크를 누르세요. (최대 10초)',
        memo_recording: '녹음 중... 지금 말씀하세요. (최대 10초)',
        enter_memo_manually: '영감을 직접 입력하기'
        
    }, // <--- 닫는 중괄호(})는 이 위치에 있어야 합니다.
    ...
    en: {
        ...
        auth_error_desc: 'Failed to load user authentication information. Please try again later or contact the administrator.',
        ...
        auth_generic_error: 'An unexpected authentication error occurred: {0}', // 👈 추가된 키
        ...
        auth_reset_prompt: "Remembered your password?",
        ...
        apiReturnedEmptyResponse: 'API returned an empty response.', // 공백 제거
        ...
        copilotAssistant: 'SermonNote Q&A Copilot',
        copilotDesc: 'Instantly answers questions about SermonNote usage, features, and troubleshooting.',
        copilotInputPlaceholder: 'Ask a question about SermonNote usage...',
        copilotFAB: 'Open Copilot',
        // 🚨 Paddle 에러 메시지 키 추가 (구독 업그레이드 오류 대응)
        paddle_sdk_error: "Payment service initialization error. Please try again later or contact the administrator.",
        paddle_checkout_success: "Subscription successful! Your account will be updated shortly.",
        paddle_checkout_closed: "Payment was cancelled or failed.",
        
        // 🎤 Quick Memo 관련 키 추가
        memo_start_guide: 'Press the microphone to record a short inspiration memo (max 10 seconds).',
        memo_recording: 'Recording... Speak now (max 10 seconds).',
        enter_memo_manually: 'Enter inspiration manually'
    },
    // ----------------------------------------------------
    // 3. 러시아어 (Russian: ru)
    // ----------------------------------------------------
    ru: {
        ...
        auth_error_desc: 'Не удалось загрузить информацию об аутентификации пользователя. Повторите попытку позже или свяжитесь с администратором.',
        auth_invalid_email: 'Неверный формат адреса электронной почты.',
        auth_user_disabled: 'Учетная запись отключена.',
        ...
        auth_generic_error: 'Произошла непредвиденная ошибка аутентификации: {0}', // 👈 추가된 키
        ...
        auth_reset_sent: 'Ссылка для сброса пароля отправлена на вашу электронную почту. Проверьте свою почту.',
        auth_unexpected_error: 'Произошла непредвиденная ошибка. Повторите попытку позже.',
        // LoginModal UI 키
        email_placeholder: "Адрес электронной почты",
        password_placeholder: "Пароль (6+ символов)",
        ...
        auth_reset_prompt: "Вспомнили свой пароль?",
        ...
        year: 'год', month: 'месяц', billedAnnualy: 'Счет выставляется ежегодно по ${0}', saveVsMonthly: 'Сэкономьте {0}% по сравнению с ежемесячной оплатой',
        subscriptionSuccessful: 'Подписка прошла успешно!', welcomePremiumTier: 'Добро пожаловать в Премиум Членство. Наслаждайтесь неограниченным доступом ко всем функциям SermonNote.',
        startWritingSermons: 'Начать писать проповеди',
        upgradeRequired: 'Требуется обновление до Премиум Членства.',
        archiveAccessRestriction: 'Список общих архивов является эксклюзивной функцией Премиум Членства.',
        upgradeBenefit: 'Обновитесь, чтобы свободно просматривать и перерождать бесчисленные архивы проповедей.',
        ...
        expositoryDesc: 'Углубленный анализ и структурирование библейских текстов для завершения мощной экспозиционной проповеди.',
        realLifeDesc: 'Создавайте практичные, ориентированные на применение проповеди, связанные с современными социальными проблемами и жизненными трудностями.',
        quickMemoDesc: 'Быстро и легко превращайте краткое вдохновение или заметку о размышлении в богатую проповедь.',
        rebirthDesc: 'Загрузите существующие материалы проповеди, и AI переструктурирует и дополнит их в современном стиле.',
        upgradeDesc: 'Получите доступ ко всем функциям AI и неограниченной генерации проповедей с Премиум подпиской.',
        copilotAssistant: 'SermonNote Q&A Copilot',
        copilotDesc: 'Мгновенно отвечает на вопросы об использовании SermonNote, функциях и устранении неполадок.',
        copilotInputPlaceholder: 'Задайте вопрос об использовании SermonNote...',
        copilotFAB: 'Открыть Copilot',
        // 🚨 Paddle 에러 메시지 키 추가 (구독 업그рей드 오류 대응)
        paddle_sdk_error: "Ошибка инициализации платежного сервиса. Повторите попытку позже или свяжитесь с администратором.",
        paddle_checkout_success: "Подписка прошла успешно! Ваш аккаунт скоро обновится.",
        paddle_checkout_closed: "Платеж был отменен или не удался.",

        // 🎤 Quick Memo 관련 키 추가
        memo_start_guide: 'Нажмите на микрофон, чтобы записать короткую вдохновляющую заметку (макс. 10 секунд).',
        memo_recording: 'Идет запись... Говорите сейчас (макс. 10 секунд).',
        enter_memo_manually: 'Ввести заметку вручную'
    },
    // ----------------------------------------------------
    // 4. 중국어 (Chinese: zh)
    // ----------------------------------------------------
    zh: {
        ...
        // 구독 관련 키 (생략)
        chooseYourPlan: '选择适合您的计划', planSubtitle: 'SermonNote 提供优化的套餐。',
        ...
        copilotAssistant: '말씀노트 Q&A 코파일럿',
        copilotDesc: '말씀노트 使用方法、功能、错误解决的提问将即时得到解答。',
        copilotInputPlaceholder: '提问 말씀노트 的使用方法...',
        copilotFAB: '打开 Copilot',
        // 🚨 Paddle 에러 메시지 키 추가 (구독 업그레이드 오류 대응)
        paddle_sdk_error: "支付服务初始化错误。请稍后重试或联系管理员。",
        paddle_checkout_success: "订阅成功！您的账户将很快更新。",
        paddle_checkout_closed: "支付已取消或失败。",

        // 🎤 Quick Memo 관련 키 추가
        memo_start_guide: '按住麦克风开始录制一段简短的灵感备忘录（最长 10 秒）。',
        memo_recording: '正在录制... 请说话（最长 10 秒）。',
        enter_memo_manually: '手动输入灵感'
    },
    // ----------------------------------------------------
    ...
    vi: {
        ...
        auth_error_desc: 'Không thể tải thông tin xác thực người dùng. Vui lòng thử lại sau hoặc liên hệ với quản trị viên.',
        auth_invalid_email: 'Định dạng địa chỉ email không hợp lệ.',
        ...
        auth_generic_error: 'Đã xảy ra lỗi xác thực không mong muốn: {0}', // 👈 추가된 키
        auth_password_mismatch: 'Mật khẩu và mật khẩu xác nhận không khớp.',
        auth_register_success: 'Đăng ký thành công! Bạn sẽ được đăng nhập tự động.',
        auth_login_success: 'Đăng nhập thành công!',
        auth_reset_sent: 'Liên kết đặt lại mật khẩu đã được gửi đến email của bạn. Vui lòng kiểm tra email.',
        auth_unexpected_error: 'Đã xảy ra lỗi không mong muốn. Vui lòng thử lại sau.',
        // LoginModal UI 키
        email_placeholder: "Địa chỉ email",
        password_placeholder: "Mật khẩu (6+ ký tự)",
        ...
        auth_reset_prompt: "Bạn đã nhớ mật khẩu của mình chưa?",
        ...
        monthly: 'Hàng tháng', annually: 'Hàng năm', saveUpTo: 'Tiết kiệm {0}%', bestValue: 'Giá trị Tốt nhất',
        planFreeMember: 'Thành viên Miễn phí', freePlanDescription: 'Trải nghiệm các tính năng cơ bản của SermonNote miễn phí.',
        planStandardMember: 'Thành viên Tiêu chuẩn', standardPlanDescription: 'Cung cấp các tính năng cốt lõ이 giúp tăng hiệu quả chuẩn bị bài giảng.',
        ...
        "sermonGenTimes_free": "Tạo bài giảng 5 lần/tháng", "aiAnnotationTimes_free": "5 AI Annotations/month",
        "sermonGenTimes_std": "200 Sermons/month", "aiAnnotationTimes_std": "200 AI Annotations/month",
        "sermonGenTimes_prem": "400 Sermons/month",
        "textEditor": "Trình chỉnh sửa văn bản", "advancedTextEditor": "Trình chỉnh sửa văn bản AI nâng cao",
        "archiveAccessRestricted": "Truy cập Kho lưu trữ (Giới hạn)", "archiveAccessFull": "Truy cập Kho lưu trữ (Đầy đủ)",
        "archiveShareLimited_free": "Đăng ký lưu trữ 1 lần/tháng", "archiveShareLimited_std": "Đăng ký lưu trữ 5 lần/tháng",
        "archiveShareLimited_prem": "Đăng ký lưu trữ 10 lần/tháng",
        ...
        copilotAssistant: 'Trợ lý Q&A SermonNote',
        copilotDesc: 'Giải đáp tức thì các câu hỏi về cách sử dụng, tính năng và khắc phục sự cố của SermonNote.',
        copilotInputPlaceholder: 'Đặt câu hỏi về cách sử dụng SermonNote...',
        copilotFAB: 'Mở Copilot',
        // 🚨 Paddle 에러 메시지 키 추가 (구독 업그레이드 오류 대응)
        paddle_sdk_error: "Lỗi khởi tạo dịch vụ thanh toán. Vui lòng thử lại sau hoặc liên hệ với quản trị viên.",
        paddle_checkout_success: "Đăng ký thành công! Tài khoản của bạn sẽ được cập nhật trong thời gian ngắn.",
        paddle_checkout_closed: "Thanh toán đã bị hủy hoặc thất bại.",

        // 🎤 Quick Memo 관련 키 추가
        memo_start_guide: 'Nhấn vào micro để ghi âm ghi chú cảm hứng ngắn (tối đa 10 giây).',
        memo_recording: 'Đang ghi âm... Hãy nói ngay (tối đa 10 giây).',
        enter_memo_manually: 'Nhập cảm hứng thủ công'
    },
};
